                    ...
                    for (int x = 0; x < VoxelPlayEnvironment.CHUNK_SIZE; x++, voxelIndex++) {
                        ...
                        case RenderType.Cutout: {
                                ...
                                if (allowAO || type.overrideMaterial || type.texturesCustomPacking) {
                                    ...
                                    // top face
                                    if (chunk_top_middle_middle [top_middle_middle].opaque < FULL_OPAQUE) {
                                        // Top face
                                        // Vertex 2
                                    ...
                                    // bottom face
                                    if (chunk_bottom_middle_middle [bottom_middle_middle].opaque < FULL_OPAQUE) {
                                        // Vertex 1
                        ...
                        case RenderType.Opaque6tex: {
                                ...
                                bool doNotPackVertices = type.overrideMaterial || type.texturesCustomPacking || env.enableCurvature;
