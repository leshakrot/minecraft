...
namespace VoxelPlay
{
    ...
    public delegate bool VoxelSpreadBeforeEvent (VoxelDefinition voxeltype, Vector3 newPosition, VoxelDefinition voxelOnNewPosition);
    public delegate void VoxelSpreadAfterEvent (VoxelDefinition voxeltype, Vector3 newPosition);
